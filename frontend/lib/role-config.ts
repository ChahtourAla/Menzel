...
export const localDamlParties = {
  easycoin:
    "Easycoin::1220c6e812603af460253aa448c484ede029521f6c59e941da101a1fc374e9a0e86f",
  owner:
    "Owner::1220c6e812603af460253aa448c484ede029521f6c59e941da101a1fc374e9a0e86f",
  investor1:
    "Investor1::1220c6e812603af460253aa448c484ede029521f6c59e941da101a1fc374e9a0e86f",
  investor2:
    "Investor2::1220c6e812603af460253aa448c484ede029521f6c59e941da101a1fc374e9a0e86f",
  investor3:
    "Investor3::1220c6e812603af460253aa448c484ede029521f6c59e941da101a1fc374e9a0e86f",
  investor4:
    "Investor4::1220c6e812603af460253aa448c484ede029521f6c59e941da101a1fc374e9a0e86f",
  auditor:
    "Auditor::1220c6e812603af460253aa448c484ede029521f6c59e941da101a1fc374e9a0e86f",
  paymentVerifier:
    "PaymentVerifier::1220c6e812603af460253aa448c484ede029521f6c59e941da101a1fc374e9a0e86f",
  legalAdmin:
    "LegalAdmin::1220c6e812603af460253aa448c484ede029521f6c59e941da101a1fc374e9a0e86f",
} as const;
  ...
  OWNER: {
    ...
    sections: [
      ...
      },
      {
        ...
        description:
          "See upfront liquidity, retained profit, and final payout.",
    ...
    sections: [
      {
        title: "Validation",
        description:
          "Validate the owner or Easycoin-submitted managed contract.",
    ...
    sections: [
      {
        ...
        description:
          "Accept or inspect the performance report before final settlement.",
    ...
    sections: [
      {
        ...
        description:
          "Match subscription payment references with bank confirmation.",
      ...
      },
      {
        ...
        description:
          "Review created funding confirmations after payment approval.",
        actionLabel: "Open trail",
        href: "/dashboard/transactions",
        icon: FileText,
      },
    ...
    sections: [
      {
        ...
        description:
          "Review the managed contract and owner confirmation status.",
      ...
      },
      {
        ...
        description:
          "Review the record trail for compliance and legal visibility.",
        actionLabel: "Open trail",
        href: "/dashboard/transactions",
        icon: ScrollText,
      },
